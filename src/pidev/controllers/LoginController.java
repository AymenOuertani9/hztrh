...
public class LoginController implements Initializable {
    ...
    private void goRegister(ActionEvent event) throws IOException {
        ...
        Parent parent = FXMLLoader.load(getClass().getResource("/gui/Registration.fxml"));
    ...
    private void facebookcnct() throws SQLException, IOException, ParseException {
        String domain = "https://localhost";
        String appId = "242073250350099";
        String appSecret = "80d4f6fcfb1bf33577d7ff19496c8d83";
    ...
    public AnchorPane getRole(fos_user user) throws IOException {
        ...
        if (user.getRoles().contains("ROLE_ADMIN")) {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/homeclient.fxml"));
            root = (AnchorPane) loader.load();
        }
        return root;
    }
